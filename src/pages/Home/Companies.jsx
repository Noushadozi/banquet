...
const Companies = () => {
    return (
        <div className="my-[100px] w-[420px] md:w-[90%] mx-auto">
            <h3 className="text-5xl text-[#3e3930] mb-[40px] md:mx-[0] mx-[10px] font-Cormorant italic">Companies work with us</h3>
