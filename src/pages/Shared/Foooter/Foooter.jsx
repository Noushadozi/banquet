        ...
        <div>
            <footer className="footer w-100% bg-[#F4F4F1] p-[100px] md:px-[150px] xl:px-[250px] lg:px-[200px]  text-base-content">
                <nav>
                    ...
                    <a className="text-[#9E9A94]">ABOUT US</a>
                    <a className="text-[#9E9A94]">CONTACT</a>
                </nav>
                <nav>
                    <a className="text-[#9E9A94]">FACEBOOK</a>
                    <a className="text-[#9E9A94]">TWITTER</a>
                    <a className="text-[#9E9A94]">INSTAGRAM</a>
                </nav>
